file('bin/kiss', '755', '$srcdir/kiss')
file('bin/kiss-chroot', '755', '$srcdir/contrib/kiss-chroot')
file('bin/kiss-depends', '755', '$srcdir/contrib/kiss-depends')
file('bin/kiss-fork', '755', '$srcdir/contrib/kiss-fork')
file('bin/kiss-manifest', '755', '$srcdir/contrib/kiss-manifest')
